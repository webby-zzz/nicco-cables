...
const PowerGenerationPage: React.FC = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const sections = [
    {
      ...
      description: "Designed for low-voltage power distribution and control in power generation facilities, our LT Power & Control Cables deliver excellent insulation strength, mechanical protection, and fire safety. Available up to 1.1 kV with armoured / unarmoured variants and FR / FRLS / LSZH sheath options. Compliant with IS 1554 (Part 1), IS 7098 (Part 1), IEC 60502-1, and BS/EN standards.",
      technical: [
      ...
      variants: [
        ...
        { label: "Applications", value: "Power supply, control, monitoring and signalling circuits in power generation facilities" }
      ]
    },
    {
      id: "ht-cables",
    ...
    },
    {
      ...
      description: "Engineered for accurate signal transmission between field instruments and control systems in power generation facilities, our Instrumentation Cables deliver exceptional noise rejection and signal integrity. Available in Cores, Pairs, Triads, and Quads with FR / FRLS / LSZH options. Compliant with BS EN 50288-7, IEC 60502-1, BS 5308 Part 1 & 2, and VDE-0815 & 0816.",
      technical: [
    ...
    },
    {
      ...
      variants: [
        ...
        { label: "Applications", value: "Fire alarms, emergency lighting, public address systems — power plants, airports, metro, high-rise buildings" }
      ]
    }
  ];
        ...
        >
          <div className="md:w-1/2">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-[44px] font-black text-brand-dark tracking-tighter mb-6 leading-[1.1]">
              Power Generation - <span className="text-brand-secondary">Nuclear, Hydro & Thermal Power</span>
            </h1>
          ...
          <div className="md:w-1/2 w-full h-64 md:h-80 bg-brand-ash rounded-[2rem] shadow-lg overflow-hidden">
            <img 
              src="https://picsum.photos/seed/powergen/1200/800" 
          ...
          {sections.map((section, index) => (
            ...
            >
              ...
              <div className="flex flex-col gap-8">
                ...
                {section.testing && <TechnicalTable title="Fire Performance Testing" data={section.testing} />}
