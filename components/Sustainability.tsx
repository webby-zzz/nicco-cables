...
const Sustainability: React.FC = () => {
  const sustainabilityItems = [
    { icon: Leaf, text: "Eco-friendly insulation materials", img: "https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?auto=format&fit=crop&q=80&w=200" },
    { icon: Recycle, text: "95% recyclable packaging", img: "https://images.unsplash.com/photo-1532996122724-e3c354a0b15b?auto=format&fit=crop&q=80&w=200" },
    { icon: Sun, text: "Solar powered manufacturing hubs", img: "https://images.unsplash.com/photo-1509391366360-fe5bb658582f?auto=format&fit=crop&q=80&w=200" },
    { icon: Droplets, text: "Zero wastewater discharge", img: "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?auto=format&fit=crop&q=80&w=200" }
  ];

  return (
    <section id="sustainability" className="py-24 md:py-40 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 md:px-12 mb-16">
        <h2 className="text-xs font-bold text-brand-secondary uppercase tracking-[0.4em] mb-6 block">RESPONSIBILITY</h2>
        <h3 className="text-4xl md:text-6xl font-black text-brand-dark tracking-tighter leading-none">
          Cabling a <br /> <span className="text-brand-secondary">Greener</span> Tomorrow.
        </h3>
      </div>
