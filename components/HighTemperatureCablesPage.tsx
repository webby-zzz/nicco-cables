        ...
        >
          <div className="md:w-1/2">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-[44px] font-black text-brand-dark tracking-tighter mb-6 leading-[1.1]">
              <SplitTitle title="High Temperature Cables (ETFE / FEP / PTFE)" />
            </h1>
          ...
          <div className="md:w-1/2 w-full">
            <div className="w-full aspect-[4/3] bg-white rounded-[2rem] shadow-lg overflow-hidden flex items-center justify-center border border-gray-100 p-4">
              <img 
                src="/brand identity/High Temperature.webp" 
                alt="High Temperature Cables" 
