        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-500">
          <div className="relative w-full max-w-2xl bg-white rounded-3xl overflow-hidden shadow-2xl animate-in zoom-in-95 duration-300">
            ...
            <div className="relative aspect-square">
              ...
              />
              <div className="absolute bottom-0 left-0 right-0 p-8 bg-gradient-to-t from-black/80 via-black/40 to-transparent flex flex-col items-center">
                <button 
                  onClick={handleRegisterClick}
                  className="px-10 py-4 bg-brand-secondary text-white font-black uppercase tracking-widest rounded-full hover:bg-white hover:text-brand-dark transition-all shadow-xl shadow-brand-secondary/20 transform hover:scale-105 active:scale-95"
                >
                  Register Now
                </button>
              </div>
