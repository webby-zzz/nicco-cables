  ...
  return (
    <section id="products" className="py-24 md:py-32 bg-white">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="mb-20">
          <span className="text-[10px] font-black uppercase tracking-[0.4em] text-brand-dark mb-4 block opacity-50">OUR PRODUCTS</span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-16">
          {products.map((product, idx) => (
            <div key={idx} className="group cursor-pointer">
              ...
              <button className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-brand-dark/40 group-hover:text-brand-secondary transition-colors group/btn">
        ...
        <div className="mt-20 flex justify-center">
          <button className="px-12 py-5 bg-brand-dark text-white rounded-xl font-bold uppercase tracking-widest text-xs hover:bg-brand-secondary transition-all shadow-xl">
            VIEW ALL PRODUCTS
          </button>
        </div>
      </div>
