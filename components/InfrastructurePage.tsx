  ...
  const sections = [
    {
      ...
      description: "Designed for low-voltage power distribution and control across infrastructure projects, our LT Power & Control Cables deliver excellent insulation strength, mechanical protection, and fire safety. Available up to 1.1 kV with armoured / unarmoured variants and FR / FRLS / LSZH sheath options. Compliant with IS 1554 (Part 1), IS 7098 (Part 1), IEC 60502-1, and BS/EN standards.",
      technical: [
      ...
      variants: [
        ...
        { label: "Applications", value: "Power supply, control, monitoring and signalling circuits across infrastructure projects" }
      ]
    },
    {
      id: "ht-cables",
      title: "HT Cables — Up to 11 kV",
      description: "Engineered for medium voltage power transmission across infrastructure networks, our HT Cables cover earthed systems from 3.3 kV to 11 kV. Available in armoured and unarmoured variants with FR / FRLS / LSZH sheath options — suitable for underground, duct, trench, and tray installations. Compliant with IS 7098 (Part 2), IEC 60502-2, and BS/EN standards.",
      technical: [
    ...
    },
    {
      ...
      description: "Engineered for accurate signal transmission between field instruments and control systems in infrastructure applications, our Instrumentation Cables deliver exceptional noise rejection and signal integrity. Available in Cores, Pairs, Triads, and Quads with FR / FRLS / LSZH options — suitable for BMS, data centres, tunnels, and metro installations. Compliant with BS EN 50288-7, IEC 60502-1, BS 5308 Part 1 & 2, and VDE-0815 & 0816.",
      technical: [
    ...
    },
    {
      ...
      description: "Engineered for high-speed and reliable data transmission across infrastructure networks, our Ethernet / LAN Cables deliver stable performance, low signal loss, and strong EMI resistance. Available in CAT 5e, CAT 6, CAT 6A, and CAT 7 variants in UTP, FTP, and SFTP configurations — ideal for data centres, BMS, tunnels, and smart building applications. Compliant with ANSI/TIA-568, ISO/IEC 11801, IEC 61156, and IEEE 802.3.",
      technical: [
      ...
      variants: [
        ...
        { label: "Applications", value: "Data centres, BMS, tunnels, metro networks, CCTV systems, telecom infrastructure, smart building applications" }
      ]
    }
  ];
        ...
        >
          <div className="md:w-1/2">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-[44px] font-black text-brand-dark tracking-tighter mb-6 leading-[1.1]">
              Infrastructure <span className="text-brand-secondary">— Building Management Systems, Data Centers, Tunnels, Metro & High Speed</span>
            </h1>
          ...
          {sections.map((section, index) => (
            ...
            >
              ...
              <div className="flex flex-col gap-8">
                ...
                {section.performance ? (
                  <>
                    <TechnicalTable title="Transmission Performance" data={section.performance} />
