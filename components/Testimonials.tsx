      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          {testimonials.map((t, i) => (
            <div key={i} className="bg-white p-12 rounded-3xl shadow-sm border border-gray-100 relative group hover:shadow-2xl transition-all duration-300 flex flex-col">
              <div className="absolute -top-6 -right-6 w-16 h-16 bg-brand-secondary rounded-full flex items-center justify-center text-white opacity-0 group-hover:opacity-100 transition-all duration-300 -rotate-12 group-hover:rotate-0 shadow-lg">
