        ...
        >
          <div className="md:w-1/2">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-[44px] font-black text-brand-dark tracking-tighter mb-6 leading-[1.1]">
              <SplitTitle title="Infrastructure" />
            </h1>
